...
// File chainlink/contracts/v0.6/SignedSafeMath.sol
...
// File chainlink/contracts/v0.6/Median.sol
...
// File chainlink/contracts/v0.6/Owned.sol
...
// File chainlink/contracts/v0.6/SafeMath128.sol
...
// File chainlink/contracts/v0.6/SafeMath32.sol
...
// File chainlink/contracts/v0.6/SafeMath64.sol
...
// File chainlink/contracts/v0.6/interfaces/AggregatorInterface.sol
...
// File chainlink/contracts/v0.6/interfaces/AggregatorV2V3Interface.sol
...
// File chainlink/contracts/v0.6/interfaces/AggregatorValidatorInterface.sol
...
// File chainlink/contracts/v0.6/FluxAggregator.sol
 ...
 */
contract FluxAggregator is AggregatorV2V3Interface, Owned, Initializable {
  address constant CLONER = address(0);
  ...
  constructor(
    ...
    __FluxAggregator_init(_link, _paymentAmount, _timeout, _validator, _minSubmissionValue, _maxSubmissionValue, _decimals, _description, msg.sender);
  }
  ...
  ) public initializer 
  {
    ...
    __FluxAggregator_init(_link, _paymentAmount, _timeout, _validator, _minSubmissionValue, _maxSubmissionValue, _decimals, _description, newOwner);
  }

  function __FluxAggregator_init(
    address _link,
    uint128 _paymentAmount,
    uint32 _timeout,
    address _validator,
